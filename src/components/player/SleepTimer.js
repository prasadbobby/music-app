...
function SleepTimer({ player }) {
  ...
  return (
    <>
      {isTimerSet ? (
        <Timer className="downfile" color="primary" onClick={() => setOpen(true)} />
      ) : (
        <TimerOff className="downfile" color="primary" onClick={() => setOpen(true)} />
      )}
      <Dialog
        style={{ zIndex: 1400 }}
        open={open}
      ...
      >
        ...
        <div className="container">
          ...
          <CircleSlider
            ...
            size={300}
            max={120}
            gradientColorFrom="#2bb4eb"
            gradientColorTo="#2617ff"
            knobRadius={25}
            progressWidth={30}
            circleWidth={30}
          />
        ...
        <DialogActions>
          <FormControlLabel
            ...
            style={{ color: "#000" }}
          />
          <Button color="#000" onClick={handleRemove}>
            Remove
          </Button>

          <Button color="#000" onClick={handleSetTimer}>
            Set
          </Button>
        </DialogActions>
      </Dialog>
