...
const playlistsIds = {
  LatestSongs: "PL0ZpYcTg19EHBJjdNGD6yWZ1-EsKFYKkG",
  RomanticSongs: "PLfZHr9_cUMTOydnp6hcAhybIyYduugHfq",
  EdmSongs: "PLw-VjHDlEOgs658kAHR_LAaILBXb-s6Q5",
  TopBolloywood: "PLRUfIEG26y92SVFpe3b4jlVWxbLlahk52",
...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <SongCard songs={songObj.topBolloywood} categotyTitle={"Top Tollywood"} />
    </>
  );
};
