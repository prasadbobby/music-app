    ...
    <Container maxWidth="sm">
      ...
      <section>
        <Typography gutterBottom={true} variant="subtitle1">
          Prasad Bobby built the EDU Music app as an Open Source app. This SERVICE is
          provided by Prasad Bobby at no cost and is intended for use as is.
          <br />
        ...
        <Typography gutterBottom={true}>
          ...
          <Link href="mailto:knvdurgaprasad610@gmail.com" target="self">
